...
int main()
{
    ...
    {                                                                   // Si no, Si esto es igual o menor a 45 horas trabajadas
        ...
        sueldoSemanal = (40 * pagoXhora + horasDobles * pagoXhora * 2); // El sueldo semanal es igual a las primeras 40 horas multiplicadas por el pago por hora + * - las horas Dobles * pago por hora por 2 (como la variable horas dobles tienen un valor negativo al multiiplicar los signos nos da -)
    }
    else if (horasT <= 50)
    {                                                // Si horas dobles son menor a 50
        ...
        /* Se multiplican las primeras 40 horas por el pago por hora, despues se le restan las primeras 40 horas quedando asi las horas restantes las cuales se multiplican por el pago por hora y se multiplican por 2, para pagar esas horas al doble, despues se multiplica las horas triples el cual se le restan las 45 horas, por lo cual solo se va a multiplicar las horas restantes las cuales se multiplicaran por el pago por hora por 3, estas pagandosde al triple.*/
    }
    else {
